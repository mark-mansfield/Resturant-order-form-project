...
const salads = [{
        ...
        dishtext: "super green salad with watercress, baby cos, mint, radish, sprouts, fennel, zucchini, cucumber, lime, ginger & apple balsamic vinaigrette",
        options: ['0', '1', '2', '3', '4']
    },
    {
...
const mains = [{
        ...
        dishtext: "Slow cooked lamb shoulder, Hawaiij spices, pomegranate molasses, honey and lemon w coriander and almonds",
        options: ['0', '1', '2', '3', '4']
    },
    {
        shortname: "salmon",
    ...
    },
    {
        ...
        dishtext: "Slow braised free range chicken, Jerusalem artichokes, bay, lemon, olives, eschallots & dates<br > (Legs & thighs- 18 pieces)",
        options: ['0', '1', '2', '3', '4']
    },
    {
        shortname: "veal",
...
const renderMenu = function () {
    ...
    // break builiding sleects out into separate function
    // The select element
...
//  beacuse chacking this by hand takes too long
...
const autoFill = function () {
    ...
    selectInputs.forEach(function (element) {
        ...
        if (element.name == 'pickUpDay' || element.name == 'pickUpTime') {
            // do nothing
        } else if (element.name == 'Chopped_liver' || element.name == 'Hommus' || element.name == 'Confit_tuna' || element.name == 'Romanian_eggplant') {
            element.value = '250g';
        } else {
            min = Math.ceil(0);
            max = Math.floor(4);
